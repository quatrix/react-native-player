...
public class AudioPlayer extends ReactContextBaseJavaModule implements ExoPlayer.Listener {

    public static final String REACT_CLASS = "AudioPlayer";
    ...
    public void play(String url, final Callback callback) {
        ...
        String agent = getDefaultUserAgent();
        MediaCodecAudioTrackRenderer render = this.buildRender(url, agent, true);
        player.prepare(render);
        player.addListener(this);
